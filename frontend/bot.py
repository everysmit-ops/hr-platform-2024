...
async def cmd_candidates(message: types.Message):
    ...
    candidates = [
        {"name": "Иван Петров", "status": "new", "date": "2024-03-14"},
        {"name": "Мария Иванова", "status": "interview", "date": "2024-03-13"},
        {"name": "Алексей Сидоров", "status": "hired", "date": "2024-03-12"}
    ]
